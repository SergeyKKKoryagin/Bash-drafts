...
MAC_ADDRESS=$(nmcli -g GENERAL.HWADDR device show eth0 | sed 's/\\//g')
nmcli connection add type ethernet con-name Проводное\ соединение\ 1 ifname eth0 ip4 172.16.16.1/24 802-3-ethernet.mac-address $MAC_ADDRESS
